...
sqlStatement = "
  CALL insert_incident_sp('2000-10-17', 'ADDISON', 'Texas'
...
sqlStatement = "
  CALL insert_incident_sp('2000-10-17', 'JAX', 'California'
    ,'UNITED AIRLINES', 'Airplane', 'landing', 200, 'No Cloud', 1)
"
...
sqlStatement = "
  CALL insert_incident_sp('2000-10-17', 'ADDISON', 'California'
    ,'UNITED AIRLINES', 'Airplane', 'landing', 200, 'No Cloud', 1)
"
...
SELECT * FROM incidents where `dep.date` = '2000-10-17'
```
